    ...
    return (
      <>
        <section className="mx-auto mt-8 max-w-full">
          <div className="grid grid-cols-2 items-stretch gap-x-1 gap-y-1 lg:grid-cols-4 lg:gap-x-[1px]">
        ...
        <div className="mt-9 flex items-center justify-center lg:hidden">
          <Link
            href="/new-in"
            className="flex h-[54px] w-[132px] items-center justify-center gap-[8px] border-[1.2px] border-[#000000] px-6 py-4"
          >
            <p
      ...
      <section className="lg:w-2xl mt-16 w-full px-6 lg:mx-auto lg:mt-24 lg:w-full lg:px-16">
        ...
        <section className="hidden lg:block">
          <header className="flex items-center justify-between">
            ...
            <Link
              href="/new-in"
              className="h-[46px] w-[122px] gap-[8px] border-[1px] border-[#000000] bg-[#FFFFFF] px-6 py-4 text-center transition-all duration-300 hover:bg-black hover:text-white"
            >
              <p
                className={`${fira_mono.className} text-center text-xs leading-[14.4px] tracking-spaced-06`}
              >
                VIEW MORE
              </p>
            </Link>
