...
const DesktopHomeScreenHoverDropdown = ({
  isSticky,
}: {
  isSticky: boolean;
}) => {
    ...
    <>
      ...
      >
        <button id="dropdownDelayButton" className="flex items-center gap-1">
          ...
          {isOpen ? (
            <span
              className={`mt-[1px] flex items-center justify-center ${isSticky ? "text-[#000000]" : "text-[#f7f7f4]"} `}
            >
...
export default DesktopHomeScreenHoverDropdown;
